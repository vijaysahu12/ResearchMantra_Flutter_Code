...
const renewMessge = 'Enjoy your benefits—renew service today!';
...
const noInternetConnectionDisplayText =
    "Please refresh or check your internet, and we’ll be back in no time!";
...
const blockUserMessage =
    'You won’t be able to see any of their posts after blocking them, but you can unblock them later from the Profile screen.';
...
const emptyScannerScreenHintText =
    "🔔 Daily updates on stock trends & strategies!";
