...
class CustomYoutubePlayerFlags {
  ...
  /// Creates [CustomYoutubePlayerFlags].
  const CustomYoutubePlayerFlags({
  ...
  /// Copies new values assigned to the [CustomYoutubePlayerFlags].
  CustomYoutubePlayerFlags copyWith({
    bool? hideControls,
    bool? autoPlay,
    bool? mute,
    ...
    return CustomYoutubePlayerFlags(
