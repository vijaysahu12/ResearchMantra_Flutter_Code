...
import 'package:research_mantra_official/ui/components/custom_youtube_player/custom_raw_youtube_player.dart';
import 'package:research_mantra_official/ui/components/custom_youtube_player/custom_youtube_player_controller.dart';
import 'package:research_mantra_official/ui/components/custom_youtube_player/custom_youyube_player.dart';
...
/// ```
///
class PackageCustomYoutubePlayer extends StatefulWidget {
  /// Creates [PackageCustomYoutubePlayer] widget.
  const PackageCustomYoutubePlayer({
    super.key,
  ...
  /// A [CustomYoutubePlayerController] to control the player.
  ...
  @override
  State<PackageCustomYoutubePlayer> createState() => _PackageCustomYoutubePlayerState();
}

class _PackageCustomYoutubePlayerState extends State<PackageCustomYoutubePlayer> {
  late CustomYoutubePlayerController controller;
  ...
  @override
  void didUpdateWidget(PackageCustomYoutubePlayer oldWidget) {
  ...
  Widget build(BuildContext context) {
    return Material(
      elevation: 0,
      color: Colors.black,
      child: InheritedCustomYoutubePlayer(
                ...
                children: [
                  Row(
                    children: [
                      ...
                      //   child: Text(
                      //     // errorString(
                      //       controller.value.errorCode.toString(),
